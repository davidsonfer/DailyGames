...
import { FavoriteCard } from "./components/favoritos";
import { Metadata } from "next";


export const metadata: Metadata = {
  title: "Meu Perfil - DalyGames sua plataforma de jogos",
  description: "Perfil Davidson Ferreira | DalyGames sua plataforma de jogos"
} 
      ...
      <Container>
        <section className="mt-8 mb-6 flex flex-col items-center justify-between relative gap-3 sm:flex-row">
          <div className="w-full flex items-center gap-4 text-lg flex-col sm:flex-row justify-center sm:justify-normal">
            ...
            />
            <h1 className="font-bold text-2xl">Davidson Ferreira</h1>
          </div>
